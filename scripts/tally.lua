...
--- The run itself: how wide, how long, how much it moves, which way.
function tally.run_line(anchor, cost, tier)
  return {
...
--- baked in. A localised string takes at most 20 parameters; six parts and five
...
function tally.summary(anchor, result, tier)
  ...
  return {
    run = tally.run_line(anchor, result.cost, tier),
